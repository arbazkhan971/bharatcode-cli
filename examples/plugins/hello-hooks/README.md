...
A tiny [Open Plugins](https://open-plugins.com) plugin that demonstrates BharatCode's
...
BharatCode discovers plugins under `~/.agents/plugins/<name>/` (user scope) and
...
# Then run BharatCode normally; you should see lines like
