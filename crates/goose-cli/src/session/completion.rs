...
/// Completer for bharatcode CLI commands
...
impl GooseCompleter {
    /// Create a new BharatCodeCompleter with a reference to the Session's completion cache
    ...
    fn hint(&self, line: &str, _pos: usize, _ctx: &Context<'_>) -> Option<Self::Hint> {
        ...
        match cache.hint_status {
            HintStatus::Interrupted => {
                Some("Interrupted, what should bharatcode work on instead?".to_string())
            }
