...
use goose::residency::ResidencyMode;
...
pub fn check_offline_residency_coherence(_config: &Config) -> CheckResult {
    ...
    let offline = goose::offline::is_offline();
    let configured = goose::residency::residency_mode();
...
pub fn check_session_db_storage() -> CheckResult {
    ...
    let data_dir = goose::config::paths::Paths::data_dir();
