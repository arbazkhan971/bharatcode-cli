...
/// Data-residency level, mirroring `goose::residency::ResidencyMode`.
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
pub fn gather() -> SecurityPosture {
    SecurityPosture {
        ...
        offline: goose::offline::is_offline(),
...
fn residency_level() -> ResidencyLevel {
    match goose::residency::residency_mode() {
        goose::residency::ResidencyMode::Strict => ResidencyLevel::Strict,
        goose::residency::ResidencyMode::Warn => ResidencyLevel::Warn,
        goose::residency::ResidencyMode::Off => ResidencyLevel::Off,
    }
}
...
pub fn config_dir_mode_warn() -> Option<bool> {
    let dir = goose::config::paths::Paths::config_dir();
