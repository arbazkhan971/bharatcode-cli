...
//!
//! Product and binary names route through [`goose::doc_manifest`] so the brand
...
pub fn cli_reference() -> String {
    let bin = goose::doc_manifest::BINARY_NAME;
...
pub fn index_page() -> String {
    let product = goose::doc_manifest::PRODUCT_NAME;
    let tagline = goose::doc_manifest::PRODUCT_TAGLINE;
