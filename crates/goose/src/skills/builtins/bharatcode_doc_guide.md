---
name: bharatcode-doc-guide
description: Reference bharatcode documentation to create, configure, or explain bharatcode-specific features like recipes, extensions, sessions, and providers. You MUST fetch relevant bharatcode docs before answering. You MUST NOT rely on training data or assumptions for any bharatcode-specific fields, values, names, syntax, or commands.
---

Use this skill when working with **bharatcode-specific features**:
- Creating or editing recipes
- Configuring extensions or providers
- Explaining how bharatcode features work
- Any bharatcode configuration or setup task

Do NOT use this skill for:
- General coding tasks unrelated to bharatcode
- Running existing recipes (just run them directly)

## Steps (COMPLETE ALL BEFORE RESPONDING)
1. **Fetch official docs**
   - Fetch the doc map from `https://bharatcode.dev/docs/bharatcode-docs-map.md`
   ...
   - If doc map shows: `guides/sessions/session-management.md`
   - Fetch: `https://bharatcode.dev/docs/guides/sessions/session-management.md`
...
2. **Create/modify content**
   - For bharatcode configuration files:
      ...
      - **⚠️ STOP: Before showing the user, verify output content MUST match the schema and reference in the bharatcode official documentation:**
...
3. **MANDATORY VERIFICATION - CHECK ALL THESE ITEMS BEFORE STEP 4**
   ...
   - [ ] You MUST NOT rely on training data or assumptions for any bharatcode-specific fields, values, names, syntax, or commands.
   ...
   - [ ] List all bharatcode-specific items in your answer (commands, fields, syntax, values, how to use, explanations, etc.)
...
4. **Provide your answer and include a "Verification Completed" section**
   - For EACH bharatcode-specific item in your response, cite the specific doc file where you verified it

5. **List documentation links**
   - Only include docs actually used
   - Remove `.md` suffix from URLs
   - Example: If you fetched `https://bharatcode.dev/docs/guides/sessions/session-management.md`, list it as `https://bharatcode.dev/docs/guides/sessions/session-management`
