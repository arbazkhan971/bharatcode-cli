...
// See LICENSES/LICENSE-codex and NOTICE. Modified during the port: removed
// `Hunk::resolve_path` and the codex-utils-path-uri / codex-utils-absolute-path
// dependencies; path resolution is performed by the std::fs applier in `apply.rs`.
