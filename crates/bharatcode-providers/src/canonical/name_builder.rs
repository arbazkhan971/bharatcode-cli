...
mod tests {
    ...
    fn test_map_to_canonical_model() {
        ...
        assert_eq!(
            map_to_canonical_model("databricks", "bharatcode-claude-4-sonnet-bedrock", r),
            Some("anthropic/claude-sonnet-4".to_string())
        );
        assert_eq!(
        ...
        assert_eq!(
            map_to_canonical_model("databricks", "kbharatcode-gpt-4o", r),
            Some("openai/gpt-4o".to_string())
        );
        assert_eq!(
        ...
        // === OpenAI O-series ===
        assert_eq!(
            map_to_canonical_model("databricks", "bharatcode-o1", r),
            Some("openai/o1".to_string())
        );
        assert_eq!(
            map_to_canonical_model("databricks", "kbharatcode-o3", r),
            Some("openai/o3".to_string())
        );
        assert_eq!(
            map_to_canonical_model("databricks", "headless-bharatcode-o3-mini", r),
        ...
        assert_eq!(
            map_to_canonical_model("databricks", "kbharatcode-grok-4.3", r),
            Some("x-ai/grok-4.3".to_string())
        );
        ...
        assert_eq!(
            map_to_canonical_model("databricks", "bharatcode-command-r-08-2024", r),
