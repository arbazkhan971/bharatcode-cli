...
//!    (`bharatcode_core::skills::discover_skills`, the same embedded markdown the agent
...
/// * any `goose_*` snake_case identifier (`goose_mode`, `bharatcode_providers`, …) —
...
/// public [`bharatcode_core::skills::discover_skills`] discovery (filtered to the embedded
...
fn embedded_surfaces() -> Vec<(String, String)> {
    ...
    for skill in bharatcode_core::skills::discover_skills(None) {
