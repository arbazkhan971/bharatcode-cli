...
use bharatcode_core::gateway::manager::GatewayStatus;
use bharatcode_core::gateway::GatewayConfig;
...
pub async fn start_gateway(
    ...
    let gw = match bharatcode_core::gateway::create_gateway(&mut config) {
        Ok(gw) => gw,
