...
use bharatcode_core::scheduler::{get_default_scheduled_recipes_dir, ScheduledJob};
...
async fn create_schedule(
    ...
    scheduler
        ...
        .await
        .map_err(|e| match e {
            bharatcode_core::scheduler::SchedulerError::CronParseError(msg) => {
                ErrorResponse::bad_request(format!("Invalid cron expression: {}", msg))
            }
            bharatcode_core::scheduler::SchedulerError::RecipeLoadError(msg) => {
                ErrorResponse::bad_request(format!("Recipe load error: {}", msg))
            }
            bharatcode_core::scheduler::SchedulerError::JobIdExists(msg) => ErrorResponse {
...
async fn delete_schedule(
    ...
    scheduler
        ...
        .await
        .map_err(|e| match e {
            bharatcode_core::scheduler::SchedulerError::JobNotFound(msg) => {
...
async fn pause_schedule(
    ...
    scheduler.pause_schedule(&id).await.map_err(|e| match e {
        ...
        bharatcode_core::scheduler::SchedulerError::AnyhowError(err) => {
