...
use bharatcode_core::providers::local_inference::hf_models::{self, HfModelInfo, HfModelVariant};
use bharatcode_core::providers::local_inference::{
...
pub async fn get_repo_files(
    ...
    let gguf_variants: Vec<_> = variants
        ...
        .map(
            |variant| bharatcode_core::providers::local_inference::hf_models::HfQuantVariant {
...
pub fn routes(state: Arc<AppState>) -> Router {
    let registered_paths: std::collections::HashSet<std::path::PathBuf> = get_registry()
        ...
        .unwrap_or_default();
    bharatcode_core::download_manager::cleanup_partial_downloads(
