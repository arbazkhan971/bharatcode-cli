...
use bharatcode_core::execution::manager::AgentManager;
...
use bharatcode_core::agents::ExtensionLoadResult;
use bharatcode_core::gateway::manager::GatewayManager;
#[cfg(feature = "local-inference")]
use bharatcode_core::providers::local_inference::InferenceRuntime;
...
impl AppState {
    ...
    pub async fn get_agent_for_route(
        &self,
        session_id: String,
    ) -> Result<Arc<bharatcode_core::agents::Agent>, StatusCode> {
