...
use bharatcode_core::agents::extension::ToolInfo;
...
use bharatcode_core::conversation::token_usage::Usage;
use bharatcode_core::conversation::Conversation;
use bharatcode_core::download_manager::{DownloadProgress, DownloadStatus};
use bharatcode_core::providers::base::{ConfigKey, ModelInfo, ProviderMetadata, ProviderType};
use bharatcode_core::session::{Session, SessionType, SystemInfo};
use bharatcode_providers::model::ModelConfig;
use bharatcode_providers::permission::Permission;
use bharatcode_providers::permission::PrincipalType;
...
#[openapi(
    ...
    components(schemas(
        ...
        bharatcode_core::providers::catalog::ProviderCatalogEntry,
        bharatcode_core::providers::catalog::ProviderTemplate,
        bharatcode_core::providers::catalog::ModelTemplate,
        bharatcode_core::providers::catalog::ModelCapabilities,
        ...
        bharatcode_core::prompt_template::Template,
        ...
        Session,
        bharatcode_providers::goose_mode::GooseMode,
        SessionType,
        SystemInfo,
        Conversation,
        IconSchema,
        IconThemeSchema,
        bharatcode_core::session::extension_data::ExtensionData,
        ...
        bharatcode_core::scheduler::ScheduledJob,
        ...
        bharatcode_core::recipe::Recipe,
        bharatcode_core::recipe::Author,
        bharatcode_core::recipe::Settings,
        bharatcode_core::recipe::RecipeParameter,
        bharatcode_core::recipe::RecipeParameterInputType,
        bharatcode_core::recipe::RecipeParameterRequirement,
        bharatcode_core::recipe::Response,
        bharatcode_core::recipe::SubRecipe,
        bharatcode_core::agents::types::RetryConfig,
        bharatcode_core::agents::types::SuccessCheck,
        ...
        bharatcode_core::agents::ExtensionLoadResult,
        super::routes::setup::SetupResponse,
        super::tunnel::TunnelInfo,
        super::tunnel::TunnelState,
        super::routes::telemetry::TelemetryEventRequest,
        bharatcode_core::goose_apps::GooseApp,
        bharatcode_core::goose_apps::WindowProps,
        bharatcode_core::goose_apps::McpAppResource,
        bharatcode_core::goose_apps::CspMetadata,
        bharatcode_core::goose_apps::PermissionsMetadata,
        bharatcode_core::goose_apps::UiMetadata,
        bharatcode_core::goose_apps::ResourceMetadata,
        super::routes::dictation::TranscribeRequest,
        super::routes::dictation::TranscribeResponse,
        bharatcode_core::dictation::providers::DictationProvider,
...
#[openapi(
    ...
    components(schemas(
        ...
        bharatcode_core::providers::local_inference::hf_models::HfModelInfo,
        bharatcode_core::providers::local_inference::hf_models::HfModelVariant,
        bharatcode_core::providers::local_inference::hf_models::HfGgufFile,
        bharatcode_core::providers::local_inference::hf_models::HfQuantVariant,
        super::routes::local_inference::RepoVariantsResponse,
        bharatcode_core::providers::local_inference::local_model_registry::ModelSettings,
        bharatcode_core::providers::local_inference::local_model_registry::ChatTemplate,
        bharatcode_core::providers::local_inference::local_model_registry::SamplingConfig,
        bharatcode_core::providers::local_inference::local_model_registry::ToolCallingMode,
    ))
)]
