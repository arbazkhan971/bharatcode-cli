...
// These are used by integration tests in crates/bharatcode-core/tests/.
    ...
    || {
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                display_name: "Todo",
                description:
                    "Enable a todo list for bharatcode so it can keep track of what it is doing",
                default_enabled: true,
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                display_name: "Apps",
                description:
                    "Create and manage custom BharatCode apps through chat. Apps are HTML/CSS/JavaScript and run in sandboxed windows.",
                default_enabled: true,
                unprefixed_tools: false,
                hidden: false,
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                description:
                    "BharatCode will make extension calls through code execution, saving tokens",
                default_enabled: false,
                unprefixed_tools: true,
                hidden: false,
                client_factory: |ctx| {
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                description:
                    "Inject custom context into every turn via BHARATCODE_MOIM_MESSAGE_TEXT and BHARATCODE_MOIM_MESSAGE_FILE environment variables",
                default_enabled: true,
                unprefixed_tools: false,
                hidden: false,
