...
use bharatcode_providers::formats::openai::{is_valid_function_name, sanitize_function_name};
    ...
    fn set_up_action_required_message(id: &str, tool_call: CallToolRequestParams) -> Message {
        Message::new(
            ...
            vec![MessageContent::action_required(
                ...
                Some("bharatcode would like to call the above tool. Allow? (y/n):".to_string()),
            )],
        )
    }
