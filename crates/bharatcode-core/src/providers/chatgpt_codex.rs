...
<html>
  <head>
    <title>bharatcode - ChatGPT Authorization Successful</title>
    <style>
      body {
...
<html>
  <head>
    <title>bharatcode - ChatGPT Authorization Failed</title>
    <style>
      body {{
        font-family: system-ui, -apple-system, sans-serif;
        display: flex;
...
mod tests {
    ...
    fn inventory_configured_uses_oauth_token_cache() {
        ...
        let _guard = env_lock::lock_env([("BHARATCODE_PATH_ROOT", Some(root_path.as_str()))]);
