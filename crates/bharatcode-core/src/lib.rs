...
pub mod conversation {
    pub use bharatcode_providers::conversation::*;
}
pub mod dictation;
...
// `bharatcode_core::doc_manifest::pages()` to seed the generated index, so this manifest
...
// public API (`bharatcode_core::release`, the product's `bharatcode::release` surface) so
