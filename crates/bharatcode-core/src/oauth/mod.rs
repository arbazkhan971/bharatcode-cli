...
const CLIENT_METADATA_URL: &str = "https://bharatcode-docs.ai/oauth/client-metadata.json";
const DEFAULT_OAUTH_CALLBACK_TIMEOUT_SECS: u64 = 300;
const OAUTH_CALLBACK_TIMEOUT_ENV: &str = "BHARATCODE_OAUTH_CALLBACK_TIMEOUT_SECONDS";
...
pub async fn oauth_flow(
    ...
    let port: u16 = std::env::var("BHARATCODE_OAUTH_CALLBACK_PORT")
        .ok()
