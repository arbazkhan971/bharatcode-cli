...
impl GooseApp {
    ...
    const PRD_SCRIPT_TYPE: &'static str = "application/x-bharatcode-prd";
    const BHARATCODE_APP_TYPE: &'static str = "BharatCodeApp";
    const BHARATCODE_SCHEMA_CONTEXT: &'static str = "urn:bharatcode.ai:schema";
    ...
    pub fn from_html(html: &str) -> Result<Self, String> {
        ...
        let json_str = metadata_re
            ...
            .ok_or_else(|| "No BharatCodeApp JSON-LD metadata found in HTML".to_string())?
            .as_str();
    ...
    pub fn to_html(&self) -> Result<String, String> {
        ...
        let mut metadata = serde_json::json!({
            "@context": Self::BHARATCODE_SCHEMA_CONTEXT,
            "@type": Self::BHARATCODE_APP_TYPE,
