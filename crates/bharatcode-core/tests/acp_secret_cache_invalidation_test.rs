...
use bharatcode_core::providers::inventory::ProviderInventoryService;
use bharatcode_core::session::session_manager::SessionStorage;
...
fn mock_provider_factory() -> bharatcode_core::acp::server::AcpProviderFactory {
...
fn acp_secret_mutations_and_inventory_refresh_invalidate_global_secret_cache() {
    ...
    let _env = env_lock::lock_env([
        ("BHARATCODE_PATH_ROOT", Some(root_path.as_str())),
