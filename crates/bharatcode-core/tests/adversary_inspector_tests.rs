...
use bharatcode_core::conversation::message::{Message, MessageContent, ToolRequest};
use bharatcode_core::security::adversary_inspector::AdversaryInspector;
use bharatcode_core::tool_inspection::ToolInspector;
...
async fn test_adversary_enabled_default_tools() {
    ...
    assert!(matches!(
        results[0].action,
        bharatcode_core::tool_inspection::InspectionAction::Allow
    ));
