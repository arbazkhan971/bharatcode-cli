...
pub const TOOL_META_EXTERNAL_DISPATCH_KEY: &str = "bharatcode.external_dispatch";
...
pub const TOOL_META_TITLE_KEY: &str = "bharatcode.toolSummary.title";
...
pub const TOOL_META_CHAIN_SUMMARY_KEY: &str = "bharatcode.toolChain.summary";
...
mod tests {
    ...
    fn test_elicitation_response_defaults_action_to_accept() {
        ...
        assert_eq!(user_data, serde_json::json!({ "name": "bharatcode" }));
