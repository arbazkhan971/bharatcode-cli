# BharatCode Release Manual Testing Checklist
...
- [ ] Launch BharatCode, click reset providers, choose databricks and a model
...
- [ ] Create a file `~/.config/bharatcode/recipes/test-recipe.yaml` with the following content:
...
- [ ] Can manually add an extension using random quotes from project
  - [ ] Add new custom stdio extension with the following command and save:
    - [ ] `node /ABSOLUTE/PATH/TO/bharatcode/ui/desktop/tests/e2e/basic-mcp.ts` (use your actual project path)
...
- [ ] Install an extension from deeplink that needs env variables:
  - [ ] Use: `bharatcode://extension?cmd=npx&arg=-y&arg=%40upstash%2Fcontext7-mcp&id=context7&name=Context7&description=Use%20up-to-date%20code%20and%20docs&env=TEST_ACCESS_TOKEN`
