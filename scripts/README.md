# BharatCode benchmark scripts

This directory contains scripts for running and analyzing BharatCode benchmarks.

## run-benchmarks.sh

This script runs BharatCode benchmarks across multiple provider:model pairs and analyzes the results.

### Prerequisites

- BharatCode CLI must be built or installed
...
3. For each provider:model pair:
   - Sets the `BHARATCODE_PROVIDER` and `BHARATCODE_MODEL` environment variables
